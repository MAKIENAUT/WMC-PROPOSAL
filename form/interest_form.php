   ...
   <div class="container">
      <form name="myForm" action="interest_form.php" method="post" enctype="multipart/form-data">
         <div class="personal_tab" id="personal_tab">
            ...
            <input type="text" id="lastname" name="lastname" oninput="validate()" onclick="validate()" placeholder="Last Name">
            <input type="text" id="firstname" name="firstname" oninput="validate()" onclick="validate()" placeholder="First Name">

            <label id="address-title">Address *</label>
            <input type="text" id="address" name="address" oninput="validate()" onclick="validate()" placeholder="Address">
            <input type="text" id="country" name="country" oninput="validate()" onclick="validate()" placeholder="Country">
            <input type="text" id="state" name="state" oninput="validate()" onclick="validate()" placeholder="State">
         </div>

         <div class="contact_tab" id="contact_tab">
            <label id="contact-info">2. Contact Info *</label>
            <label id="contact-title">Contacts *</label>
            <input type="text" id="phone_number" name="phone_number" oninput="validate()" onclick="validate()" placeholder="Phone Number">
            <input type="text" id="back_up" name="back_up" oninput="validate()" onclick="validate()" placeholder="BackUp Number" value="BackUp #: Edit if available.">
            <input type="email" id="email" name="email" oninput="validate()" onclick="validate()" placeholder="Email Address" required>
         </div>
         <div class="interest_tab" id="interest_tab">
            ...
            <div class="profession">
               <select id="profession" name="profession" onclick="validate()" onchange="showfield(this.options[this.selectedIndex].value)">
               ...
               <div id="div1">If Other: <input type="text" name="other_option" id="other_option" onclick="change()" oninput="change()" />
               </div>
            </div>
            ...
            <div class="eligibility">
               ...
               <div class="yes">
                  <input type="radio" id="yes" name="eligible" value="Yes" onclick="termsAgree()" disabled>
         ...
         <div class="privacy_tab">
            <label id="contact-info">5. Set an Appointment *</label>
            <label id="contact-title">Remember to set an appointment first before proceeding to submit your form. *</label>
            <!-- Calendly inline widget begin -->
            <div class="calendly-inline-widget" data-url="https://calendly.com/mcrayescoto/wma-apointment?background_color=ddf8f8&text_color=191513&primary_color=008080" style="min-width:320px;height:630px;">
            </div>
         </div>
         <div class="privacy_tab">
            <label id="contact-info">6. Privacy Policy *</label>
            ...
            <div class="terms">
               <input type="checkbox" id="terms" name="terms" onclick="termsAgree(); submitActivator()">
               <label> Terms and Conditions *</label>
            </div>

            <div class="submit">
               <label onmouseover="submitActivator()" for="submit" id="validity_check">If submit button is still disabled, Please check the form's validity!</label>
               <br>
               <br>
               <button type="submit" name="submit" id="submit" disabled onmouseover="submitActivator()">SUBMIT</button>
            </div>
         </div>
      </form>
   </div>
